<?php namespace App\Http\Controllers;
	...
	class AdminDayWeddingPesanController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Pesan","name"=>"pesan"];
			...
			$this->form[] = ['label'=>'Pesan','name'=>'pesan','type'=>'textarea','validation'=>'required|string|min:1|max:5000','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Pesan","name"=>"pesan","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
			# OLD END FORM
	    ...
	    */
		...
		public function getActive($id){
	    	...
	    	$cek=DB::table('day_wedding_pesan')->where('id',$id)->update($status);
