	    ...
	    */
		...
		public function getIndex() {
			//First, Add an auth
			 ...
			 $data['result'] = DB::table('day_wedding')
			 ->join('day_tema','day_wedding.id_day_tema','=','day_tema.id')
             ->join('day_music','day_wedding.id_day_music','=','day_music.id')
			 ->where('day_wedding.id_cms_users',CRUDBooster::myId())
			 ->select('day_wedding.*','day_tema.nama as tema','day_music.nama as music')
			 ->get();
